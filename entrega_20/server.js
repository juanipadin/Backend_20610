...
/* CARGA DE MÉTODOS */
const authWebRouter = require('./routers/auth')
const homeRouter = require('./routers/home');
const productosRouter = require('./routers/productos');

/* CARGA MÓDULOS DE TEST DE AXIOS */
const {testAxios} = require('./test/axios');
const productosRouterGraphQl = require('./routers/productosGraphql');
...
appKoa.use(koaBody())
let productosKoa = require('./routers/productosKoa')
appKoa.use(productosKoa.routes())
const portKoa = 8081
const serverKoa = appKoa.listen(portKoa, () => {
    console.log(`Servidor Koa escuchando en puerto ${portKoa}`)
})
serverKoa.on('error', error => console.log(`Error en Servidor Koa: `, error))
...
app.use('/productos', productosRouterGraphQl)
